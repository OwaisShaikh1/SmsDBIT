...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-z9)9jk89t!)q2j27pb!+0@*n0minwrmx=b!f@wpw2e0go-!_qv')
...
MIDDLEWARE = [
    ...
    'sms_portal.middleware.Custom404ResponseMiddleware',  # Custom 404 handler
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            BASE_DIR.parent / 'frontend' / 'templates',  # Original frontend templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'frontend' / 'static',  # Frontend static files (backend/frontend/static)
]
